    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Ready to experience the comfort and hospitality of Om Vatika Guest House? 
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <p className="leading-relaxed mb-6" style={{ color: 'var(--muted)' }}>
                  Experience comfort and hospitality at its finest. Your perfect stay awaits you.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg mb-2" style={{ color: 'var(--foreground)' }}>Address</h4>
                    <p className="leading-relaxed" style={{ color: 'var(--muted)' }}>
                      AA 40, AA Block, Sec-1, Bidhannagar,<br />
                ...
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg mb-2" style={{ color: 'var(--foreground)' }}>Phone</h4>
                    <a 
                ...
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg mb-2" style={{ color: 'var(--foreground)' }}>Email</h4>
                    <a 
              ...
              <div className="pt-6 text-center">
                <h4 className="font-semibold text-lg mb-4" style={{ color: 'var(--foreground)' }}>Follow Us</h4>
                <div className="flex justify-center space-x-4">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                    >
                      <social.icon className="w-5 h-5" style={{ color: 'var(--primary)' }} />
                    </motion.a>
                  ))}
                </div>
              </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="relative">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5" style={{ color: 'var(--muted)' }} />
                  <input
                    type="text"
                    name="name"
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5" style={{ color: 'var(--muted)' }} />
                  <input
                    type="email"
                    name="email"
                ...
                <div className="relative">
                  <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5" style={{ color: 'var(--muted)' }} />
                  <input
                    type="tel"
                    name="phone"
                ...
                <div className="relative">
                  <MessageSquare className="absolute left-3 top-3 w-5 h-5" style={{ color: 'var(--muted)' }} />
                  <textarea
                    name="message"
                ...
                <motion.button
                  type="submit"
                  className="w-full py-3 px-6 rounded-lg font-semibold flex items-center justify-center space-x-2 transition-all duration-300 text-white"
                  style={{
                    background: 'linear-gradient(to right, var(--primary), var(--primary-light))',
                  }}
        ...
        >
          ...
          {/* Copyright */}
          <div className="text-center pt-4 border-t" style={{ borderColor: 'rgba(var(--primary-rgb), 0.1)' }}>
